...
class CustomTextFormFeild extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      style: textStyle ?? AppStyles.light18BlackAlpha,
      ...
      decoration: InputDecoration(
        hintText: hintText,
        hintStyle: textStyle ?? AppStyles.light18BlackAlpha,
        ...
        enabledBorder: _outlineInputBorder(
            borderRadius: borderRadius, borderSideColor: borderSideColor),
  ...
  OutlineInputBorder _outlineInputBorder(
      {Color? borderSideColor, double? borderRadius}) {
